defmodule OrganizerWeb.Components.OnboardingOverlayTest do
  ...
  describe "onboarding_overlay/1" do
    test "renders when active is true" do
      assigns = %{active: true, current_step: 1, total_steps: 5, can_skip: true}
    ...
    test "does not render when active is false" do
      assigns = %{active: false, current_step: 1, total_steps: 5, can_skip: true}
    ...
    test "renders correct step content for step 2" do
      assigns = %{active: true, current_step: 2, total_steps: 5, can_skip: true}
    ...
    test "renders correct step content for all 5 steps" do
      for step <- 1..5 do
        assigns = %{active: true, current_step: step, total_steps: 5, can_skip: true}
    ...
    test "hides skip button when can_skip is false" do
      assigns = %{active: true, current_step: 1, total_steps: 5, can_skip: false}
    ...
    test "shows 'Próximo' button when not on last step" do
      assigns = %{active: true, current_step: 3, total_steps: 5, can_skip: true}
    ...
    test "shows 'Concluir' button on last step" do
      assigns = %{active: true, current_step: 5, total_steps: 5, can_skip: true}
    ...
    test "renders progress dots for all steps" do
      ...
      # Should have 5 dots
      assert String.split(html, "rounded-full transition-all duration-200") |> length() == 6
    end
