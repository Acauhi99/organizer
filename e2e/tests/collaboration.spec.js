...
test.describe("financial collaboration flows", () => {
  test("creates invite, accepts link, shares entry and performs settlement flow", async ({ browser }) => {
    ...
    try {
      ...
      await pageA.fill("#quick-finance-amount", "250,00");
      ...
      await pageA.fill('input[name="quick_finance[description]"]', "Conta compartilhada");
