...
config :organizer, Organizer.Repo,
  database: Path.expand("../organizer_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :organizer, OrganizerWeb.Endpoint,
  ...
  watchers: [
    ...
    tailwind: {Tailwind, :install_and_run, [:organizer, ~w(--watch)]}
  ]
...
config :organizer, OrganizerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/organizer_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :organizer, dev_routes: true
