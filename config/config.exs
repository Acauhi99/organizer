...
config :organizer, :scopes,
  user: [
    default: true,
    module: Organizer.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :id,
    schema_table: :users,
    test_data_fixture: Organizer.AccountsFixtures,
...
config :organizer, Organizer.Mailer, adapter: Swoosh.Adapters.Local
