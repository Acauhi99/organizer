defmodule OrganizerWeb.UserAuth do
  ...
  @remember_me_cookie "_organizer_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      OrganizerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(_conn), do: ~p"/finances"
  ...
  @doc """
  API plug that rejects unauthenticated access with a JSON 401 response.
  """
